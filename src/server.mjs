        ...
        res.send(`
            <html>
                <head>
                    ...
                    <script>
                        function eventToElement(event, properties) {
                            return Object.assign(document.createElement('pre'), { 
                                innerHTML: JSON.stringify({ event, properties }, null, 2) 
                            })
                        }
                        function addElement(event, properties) {
                            document.getElementById('events').appendChild(eventToElement(event, properties))
                        }
